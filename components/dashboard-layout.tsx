...
export function DashboardLayout({ children, title, role }: DashboardLayoutProps) {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-900 overflow-hidden">
      <header className="bg-black shadow-sm border-b border-yellow-500 flex-shrink-0">
        <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 gap-4">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="hidden md:inline text-sm font-medium text-yellow-400">{user?.name}</span>
                <span className="text-xs bg-yellow-500 text-black px-2 py-1 rounded-full capitalize font-semibold">
                  {role}
                </span>
              </div>
              <Button 
